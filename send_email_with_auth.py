...
Sends both HR and Academic email templates with proper authentication
"""
...
def send_test_email_with_auth():
    """Send test email with proper authentication"""
    print("📧 SENDING TEST EMAIL WITH AUTHENTICATION...")
    ...
    password = "testpassword123"  # From docker-compose.yml
...
def main():
    ...
    success = send_test_email_with_auth()
    
    if success:
        print("\n✅ Test email sent successfully!")
        print("📧 Check your email at tripathy.anamay23@gmail.com")
    else:
        print("\n❌ Failed to send email - authentication issue")
