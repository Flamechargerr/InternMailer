#!/usr/bin/env python3
"""
Targeted Personalized Mass Mailing - InternMailing System
Send emails to professors with guaranteed research area personalization
"""
...
def get_targeted_professors(count=5):
    """Get professors with guaranteed research area personalization"""
    try:
        ...
        # Target professors with known research areas (from manual mappings)
        target_names = [
        ...
        print(f"Error getting targeted professors: {e}")
        return []
...
def main():
    """Main function to send targeted personalized emails"""
    print("🎯 TARGETED PERSONALIZED MASS MAILING - INTERNMAILING SYSTEM")
    print("=" * 60)
    print("Sending emails with GUARANTEED research area personalization")
    print("=" * 60)
    
    # Get recipients
    professors = get_targeted_professors(5)
    ...
    for prof in professors:
        ...
        print(f"     🔬 Alignment: {prof['research_alignment'][:80]}...")
    ...
    if professors:
        print("🎓 SENDING TARGETED PERSONALIZED PROFESSOR EMAILS...")
        print("-" * 40)
        for i, professor in enumerate(professors, 1):
            ...
            success = send_html_email_with_cv(
                ...
                subject, 
                html_content, 
                "Targeted Personalized Academic Professor", 
    ...
    print()
    print("=" * 60)
    print("📊 TARGETED PERSONALIZED MAILING RESULTS:")
    print("=" * 60)
    ...
    if results['total_sent'] == total_recipients:
        print("🎉 ALL TARGETED EMAILS SENT SUCCESSFULLY!")
        print("✅ Targeted personalized mailing system is working perfectly!")
        print("🎯 All professor emails have specific research area personalization!")
        print("🚀 Ready to scale up with more targeted professors!")
    elif results['total_sent'] >= total_recipients * 0.8:
        print("✅ Most targeted emails sent successfully!")
        print("⚠️ Some emails failed - check errors above")
        print("🔧 Fix any issues before scaling up")
    else:
        print("❌ Multiple targeted emails failed")
    ...
    print("3. If successful, expand manual mappings")
    print("4. Continue with larger targeted campaigns")
    print("=" * 60)
